# QA Note: SelfSnap Win11 QA And Privacy Notes
...
This QA note captures the privacy boundary, verification focus, and default visibility expectations for the current release shape.
