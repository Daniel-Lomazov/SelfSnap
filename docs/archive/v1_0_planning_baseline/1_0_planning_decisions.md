...
- `docs/archive/releases/common.release-readiness-criteria-v1.0.md` defines the audience as an explicit external user class.
...
- Gate #6 in `docs/archive/releases/common.release-readiness-criteria-v1.0.md` is explicit.
- `docs/archive/v1_0_planning_baseline/BENCHMARK_1_0_BASELINE.md` marks hardware validation as not yet benchmarked.
...
- `docs/archive/releases/qa.quality-assurance-and-privacy-notes-v1.md` requires first-run and Settings disclosure.
...
Evidence:
- `docs/archive/releases/common.release-readiness-criteria-v1.0.md` lists no encryption at rest under invariants, known limitations, and out-of-scope.
